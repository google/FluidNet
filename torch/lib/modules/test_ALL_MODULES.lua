...
-- Load the modules.
dofile(path .. "../../utils/calc_velocity_update.lua")
...
dofile(path .. "velocity_divergence.lua")
dofile(path .. "velocity_update.lua")
...
dofile(path .. "test_velocity_divergence.lua")
dofile(path .. "test_velocity_update.lua")
